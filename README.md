...
3. [Data preprocessing](#data-preprocessing)
  ...
  b. [Outliears](#outliears)
  c. [Transforming categorical data into numerical data](#transforming-categorical-data-into-numerical-data)
  d. [Labels and estimators](#labels-and-estimators)
  e. [Standardization and normalization](#standardization-and-normalization)
  f. [Performance metrics for regression models](#performance-metrics-for-regression-models)
  g. [Division of the set](#division-of-the-set)
4. [Building a regression model](#building-a-regression-model)
  a. [Linear Regression](#linear-regression)
  b. [MLP (Multilayer Perceptron)](#mlp-multilayer-perceptron)
  c. [SVR (Support Vector Regressor)](#svr-support-vector-regressor)
  d. [Decision tree](#decision-tree)
  e. [Random forest](#random-forest)
  f. [Gradient boosting](#gradient-boosting)
